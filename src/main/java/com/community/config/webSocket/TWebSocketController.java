...
@CrossOrigin
@Controller
public class TWebSocketController {
    ...
    @CrossOrigin
    public TGreeting greeting(THelloMessage message) throws Exception {
        Thread.sleep(1000); // simulated delay
        return new TGreeting(HtmlUtils.htmlEscape(message.getUsername()+":"+message.getContent()));//The return value is broadcast to all subscribers of /topic/greetings
    }
